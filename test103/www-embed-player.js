...
var f=new c;b.prototype.C=function(g){var h=this.i();g.Z(h.resolve,h.reject)};
...
this.Z(k(g,l),k(h,n));return r};
b.prototype["catch"]=function(g){return this.then(void 0,g)};
b.prototype.Z=function(g,h){function k(){switch(l.g){case 1:g(l.h);break;case 2:h(l.h);break;default:throw Error("Unexpected state: "+l.g);}}
var l=this;null==this.f?f.g(k):this.f.push(k)};
b.resolve=d;b.reject=function(g){return new b(function(h,k){k(g)})};
b.race=function(g){return new b(function(h,k){for(var l=q(g),n=l.next();!n.done;n=l.next())d(n.value).Z(h,k)})};
b.all=function(g){var h=q(g),k=h.next();return k.done?d([]):new b(function(l,n){function r(D){return function(J){v[D]=J;p--;0==p&&l(v)}}
var v=[],p=0;do v.push(void 0),p++,d(k.value).Z(r(v.length-1),n),k=h.next();while(!k.done)})};
return b});
...
return a}
var qc={ab:"allow-forms",bb:"allow-modals",cb:"allow-orientation-lock",eb:"allow-pointer-lock",fb:"allow-popups",gb:"allow-popups-to-escape-sandbox",hb:"allow-presentation",ib:"allow-same-origin",jb:"allow-scripts",kb:"allow-top-navigation",lb:"allow-top-navigation-by-user-activation"},sc=Ta(function(){return rc()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,n;a();return{reset:a,update:c,digest:d,va:function(){for(var r=d(),v="",p=0;p<r.length;p++)v+="0123456789ABCDEF".charAt(Math.floor(r[p]/16))+"0123456789ABCDEF".charAt(r[p]%16);return v}}}
...
function Ac(a){var b=yc();b.update(a);return b.va().toLowerCase()}
...
if("undefined"!==typeof a&&-1==Ab.indexOf("Trident")&&-1==Ab.indexOf("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(w(c.next)){c=c.next;var e=c.ka;c.ka=null;e()}};
...
m.o=function(){N.K.o.call(this);this.clear();this.i.length=0};function Hd(a){this.f=a}
...
return k}
;var He={},Ie=0;
function Je(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Ab,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof H||(a="object"==typeof a&&a.I?a.H():String(a),xb.test(a)||(a="about:invalid#zClosurez"),a=zb(a)),b=wb(a).toString(),"about:invalid#zClosurez"===b?a="":(b instanceof Db?a=b:(d="object"==typeof b,a=null,d&&b.ga&&(a=b.da()),b=nb(d&&b.I?b.H():String(b)),a=Hb(b,a)),a=Fb(a).toString(),a=encodeURIComponent(String(hd(a)))),/^[\s\xa0]*$/.test(a)||(a=dc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
...
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Wb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),Ne[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Za:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},F:{url:P("PAGE_NAME",window.location.href),
...
Sf.prototype.o=function(){window.clearInterval(this.J);Qf(this.C)};var Tf={};
function Uf(a){var b=void 0===a?{}:a;a=void 0===b.Aa?!0:b.Aa;b=void 0===b.Oa?!1:b.Oa;if(null==z("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Vf();V(document,"keydown",Vf);V(document,"keyup",Vf);V(document,"mousedown",Vf);V(document,"mouseup",Vf);a&&(b?V(window,"touchmove",function(){Wf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Wf("resize",200)}),V(window,"scroll",function(){Wf("scroll",200)})));
...
function jg(a,b){var c=ag[a],d=hg[a]||{};hg[a]=d;var e=Math.round(U());for(l in W[a]){var f=bb,g=b.f;g={client:{hl:g.Ha,gl:g.Ga,clientName:g.Ea,clientVersion:g.Fa,configInfo:g.Da}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(g.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=lg(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=gg[l])a:{var k=
...
function pg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Xf())};R("log_sequence_info_on_gel_web")&&d.O&&(a=e.context,b=d.O,og[b]=b in og?og[b]+1:0,a.sequence={index:og[b],groupKey:b},d.qb&&delete og[d.O]);(d=d.ca)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),gg[d.token]=a,d=lg("log_event",d.token)):d=lg("log_event");d.push(e);c&&(dg.log_event=new c);d.length>=(oe("web_logging_max_batch")||
100)?ig():kg()}
...
c=q(c);for(var e=c.next();!e.done;e=c.next())e=rg(e.value),(Ya(e)||!e.trackingParams&&!e.veType)&&Pe(Error("Child VE logged with no data"),"WARNING");c={ca:void 0,O:a};"UNDEFINED_CSN"==a?vg("visualElementAttached",b,c):pg("visualElementAttached",b,d,c)}
function vg(a,b,c){a={ub:a,payload:b,options:c};(b=P("INTERACTIONS_LOGGER_QUEUE",void 0))?b.push(a):O("INTERACTIONS_LOGGER_QUEUE",[a])}
;function wg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.nb||P("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().mb:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
;function ug(a){var b=this;this.f=a||{Ba:$d("INNERTUBE_API_KEY"),Ca:$d("INNERTUBE_API_VERSION"),Da:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ea:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Fa:$d("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ha:$d("INNERTUBE_CONTEXT_HL"),Ga:$d("INNERTUBE_CONTEXT_GL"),Ia:$d("INNERTUBE_HOST_OVERRIDE")||"",Ja:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};rf(function(){Dg(b)},0,5E3)}
function mg(a,b,c,d){!P("VISITOR_DATA")&&.01>Math.random()&&Q(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",F:c,oa:"JSON",N:function(){d.N()},
na:d.N,onSuccess:function(v,p){if(d.onSuccess)d.onSuccess(p)},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ia;g&&(f=g);g=a.f.Ja||!1;var h=wg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ie(""+f+("/youtubei/"+a.f.Ca+"/"+b),{alt:"json",key:a.f.Ba}),l;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Bg(b,c,h,g))){var n=e.onSuccess,r=e.ma;e.onSuccess=function(v,p){Cg(l);n(v,p)};
c.ma=function(v,p){Cg(l);r(v,p)}}try{R("use_fetch_for_op_xhr")?ye(k,e):(e.method="POST",e.F||(e.F={}),Be(k,e))}catch(v){if("InvalidAccessError"==v)l&&(Cg(l),l=0),Q(Error("An extension is blocking network request."),"WARNING");
...
t(Pg,L);Pg.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.ob)}L.prototype.o.call(this)};var Qg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Rg(a){a=a||"";if(window.spf){var b=a.match(Qg);spf.style.load(a,b?b[1]:"",void 0)}else Sg(a)}
...
;function Vg(a,b,c,d){L.call(this);var e=this;this.l=this.W=a;this.T=b;this.A=!1;this.api={};this.U=this.C=null;this.D=new N;Tc(this,Ia(Uc,this.D));this.i={};this.P=this.V=this.h=this.ba=this.f=null;this.J=!1;this.j=this.B=null;this.X={};this.sa=["onReady"];this.aa=null;this.ja=NaN;this.R={};this.m=d;Wg(this);this.Y("WATCH_LATER_VIDEO_ADDED",this.La.bind(this));this.Y("WATCH_LATER_VIDEO_REMOVED",this.Ma.bind(this));this.Y("onAdAnnounce",this.ua.bind(this));this.ta=new Pg(this);Tc(this,Ia(Uc,this.ta));
this.S=0;c?this.S=S(function(){e.loadNewVideoConfig(c)},0):d&&(Xg(this),Yg(this))}
t(Vg,L);m=Vg.prototype;m.getId=function(){return this.T};
m.loadNewVideoConfig=function(a){if(!this.g){this.S&&(T(this.S),this.S=0);a instanceof Og||(a=new Og(a));this.ba=a;this.f=a.clone();Xg(this);this.V||(this.V=Zg(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=vc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=vc(Number(a)||a);Yg(this);this.A&&$g(this)}};
function Xg(a){var b;a.m?b=a.m.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.T,a.f.attrs.id=a.T);a.l.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
m.xa=function(){return this.ba};
function $g(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function ah(a){var b=!0,c=bh(a);c&&a.f&&(a=ch(a),b=Ue(c,"version")==a);return b&&!!z("yt.player.Application.create")}
function Yg(a){if(!a.g&&!a.J){var b=ah(a);if(b&&"html5"==(bh(a)?"html5":null))a.P="html5",a.A||dh(a);else if(eh(a),a.P="html5",b&&a.j)a.W.appendChild(a.j),dh(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.B=function(){c=!0;var d=z("yt.player.Application.create"),e=a.f?a.f.clone():void 0;d(a.W,e,a.m);dh(a)};
a.J=!0;b?a.B():(hf(ch(a),a.B),Rg(a.m?a.m.cssUrl:a.f.assets.css),fh(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function bh(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function dh(a){if(!a.g){var b=bh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.J=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||gh(a)):a.ja=S(function(){dh(a)},50)}}
function gh(a){Wg(a);a.A=!0;var b=bh(a);b.addEventListener&&(a.C=hh(a,b,"addEventListener"));b.removeEventListener&&(a.U=hh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=hh(a,b,e))}for(var f in a.i)a.C(f,a.i[f]);$g(a);a.V&&a.V(a.api);a.D.L("onReady",a.api)}
function hh(a,b,c){var d=b[c];return function(){try{return a.aa=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.aa=e,fe(e))}}}
function Wg(a){a.A=!1;if(a.U)for(var b in a.i)a.U(b,a.i[b]);for(var c in a.R)T(parseInt(c,10));a.R={};a.C=null;a.U=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Y.bind(a);a.api.removeEventListener=a.Qa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.ya.bind(a);a.api.getPlayerType=a.za.bind(a);a.api.getCurrentVideoConfig=a.xa.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ka.bind(a)}
m.Ka=function(){return this.A};
m.Y=function(a,b){var c=this,d=Zg(this,b);if(d){if(!(0<=La(this.sa,a)||this.i[a])){var e=ih(this,a);this.C&&this.C(a,e)}this.D.subscribe(a,d);"onReady"==a&&this.A&&S(function(){d(c.api)},0)}};
m.Qa=function(a,b){if(!this.g){var c=Zg(this,b);c&&Fd(this.D,a,c)}};
function Zg(a,b){var c=b;if("string"==typeof b){if(a.X[b])return a.X[b];c=function(){var d=z(b);d&&d.apply(u,arguments)};
a.X[b]=c}return c?c:null}
function ih(a,b){var c="ytPlayer"+b+a.T;a.i[b]=c;u[c]=function(d){var e=S(function(){if(!a.g){a.D.L(b,d);var f=a.R,g=String(e);g in f&&delete f[g]}},0);
Za(a.R,String(e))};
return c}
...
m.za=function(){return this.P||(bh(this)?"html5":null)};
m.ya=function(){return this.aa};
function eh(a){a.cancel();Wg(a);a.P=null;a.f&&(a.f.loaded=!1);var b=bh(a);b&&(ah(a)||!fh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.W;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.B&&of(ch(this),this.B);T(this.ja);this.J=!1};
m.o=function(){eh(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){Q(b)}this.X=null;for(var a in this.i)u[this.i[a]]=null;this.ba=this.f=this.api=null;delete this.W;delete this.l;L.prototype.o.call(this)};
function fh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function ch(a){return a.m?a.m.jsUrl:a.f.assets.js}
;var jh={},kh="player_uid_"+(1E9*Math.random()>>>0);function lh(a){delete jh[a.getId()]}
;function mh(a,b,c){c=void 0===c?{}:c;var d=ug;P("ytLoggingEventsDefaultDisabled",!1)&&ug==ug&&(d=null);pg(a,b,d,c)}
...
sh.prototype.toString=function(){return this.topic};var th=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.M;N.prototype.publish=N.prototype.L;N.prototype.clear=N.prototype.clear;y("ytPubsub2Pubsub2Instance",th,void 0);y("ytPubsub2Pubsub2SubscribedKeys",z("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);y("ytPubsub2Pubsub2TopicToKeys",z("ytPubsub2Pubsub2TopicToKeys")||{},void 0);y("ytPubsub2Pubsub2IsAsync",z("ytPubsub2Pubsub2IsAsync")||{},void 0);
...
function wh(){var a=vh(),b;for(b in a)tf(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function xh(a,b){rh.call(this,1,arguments)}
t(xh,rh);function yh(a,b){rh.call(this,1,arguments)}
t(yh,rh);var zh=new sh("aft-recorded"),Ah=new sh("timing-sent");function Bh(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ja("ytcsi.data_",a));return a}
function Ch(){var a=Bh().nonce;a||(a=Fg(),Bh().nonce=a);return a}
;function Dh(){return!!R("csi_on_gel")||!!Bh().useGel}
function Eh(){var a=Bh();if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function Fh(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Gh(a)||c.some(function(e){return!Gh(e)}))throw Error("Only objects may be merged.");
c=q(c);for(d=c.next();!d.done;d=c.next())Hh(a,d.value)}
function Hh(a,b){for(var c in b)if(Gh(b[c])){if(c in a&&!Gh(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Hh(a[c],b[c])}else if(Ih(b[c])){if(c in a&&!Ih(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Jh(a[c],b[c])}else a[c]=b[c];return a}
function Jh(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,Gh(d)?a.push(Hh({},d)):Ih(d)?a.push(Jh([],d)):a.push(d);return a}
function Gh(a){return"object"===typeof a&&!Array.isArray(a)}
function Ih(a){return"object"===typeof a&&Array.isArray(a)}
...
"playerInfo.preloadType",Y.yt_ad_pr="prerollAllowed",Y.pa="previousAction",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.aq="tvInfo.appQuality",Y.br_trs="tvInfo.bedrockTriggerState",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Mh="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),
Nh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Oh={},Ph=(Oh.mver="MEASUREMENT_VERSION_",Oh.pis="PLAYER_INITIALIZED_STATE_",Oh.yt_pt="LATENCY_PLAYER_",Oh.pa="LATENCY_ACTION_",Oh.yt_vst="VIDEO_STREAM_TYPE_",Oh),Qh=!1;
function Rh(){Bh().info.yt_lt="hot_bg";if(Dh()){var a="hot_bg";var b=Eh();(b.gelInfos?b.gelInfos:b).info_yt_lt=!0;if("yt_lt"in Lh){var c=Lh.yt_lt;0<=La(Nh,c)&&(a=!!a);"yt_lt"in Ph&&(a=Ph.yt_lt+a.toUpperCase());b={};c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];d[c[c.length-1]]=a;a=b}else 0<=La(Mh,"yt_lt")||(a=Error("Unknown label logged with GEL CSI"),a.params="yt_lt",fe(a)),a=void 0;a&&Dh()&&(b=Eh(),"gelInfos"in b||(b.gelInfos={}),Fh(b.gelInfos,a),b=Ch(),c=Object.keys(a).join(""),
ph("info_"+c+"_"+b)||(a.clientActionNonce=b,mh("latencyActionInfo",a)))}}
...
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Th(){return Bh().tick}
function Uh(){var a=Th(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Bh().info.yt_pvis}
function Vh(){wh();if(!Dh()){var a=Th(),b=Bh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in Kh){var e=Na(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=P("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:P("TIMING_ACTION",void 0)};d=Rh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Sh();Uh()&&"youtube"==e&&(Rh(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=Rf();h={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=z("ytdebug.logTiming"))&&a(f,h);Wh(f,!!b.ap);uh(Ah,new yh(h.aft+(d||0),void 0))}}
...
;function ai(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Tc(this,Ia(Uc,this.f))}
C(ai,L);ai.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
ai.prototype.j=function(a,b){this.g||this.f.L.apply(this.f,arguments)};function bi(a,b,c){ai.call(this);this.h=a;this.i=b;this.l=c}
t(bi,ai);function ci(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(hd(a),d.i))}}
bi.prototype.o=function(){this.i=this.h=null;ai.prototype.o.call(this)};function di(a){L.call(this);this.f=a;this.f.subscribe("command",this.qa,this);this.h={};this.j=!1}
t(di,L);m=di.prototype;m.start=function(){this.j||this.g||(this.j=!0,ci(this.f,"RECEIVING"))};
m.qa=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":x(d.event)&&(a=d.event,a in this.h||(c=A(this.Sa,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":x(d.event)&&ei(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=fi(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=gi(a,c))&&this.j&&!this.g&&ci(this.f,a,c))}}};
m.Sa=function(a,b){this.j&&!this.g&&ci(this.f,a,this.ea(a,b))};
m.ea=function(a,b){if(null!=b)return{value:b}};
function ei(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.o=function(){var a=this.f;a.g||Fd(a.f,"command",this.qa,this);this.f=null;for(var b in this.h)ei(this,b);L.prototype.o.call(this)};function hi(a,b){di.call(this,b);this.i=a;this.start()}
t(hi,di);hi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
hi.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function fi(a,b){switch(a){case "loadVideoById":return b=Zh(b),[b];case "cueVideoById":return b=Zh(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=$h(b),[b];case "cuePlaylist":return b=$h(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
hi.prototype.ea=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return di.prototype.ea.call(this,a,b)};
hi.prototype.o=function(){di.prototype.o.call(this);delete this.i};function ii(a,b,c){L.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.A="*";this.i=c;this.sessionId=null;this.channel="widget";this.B=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h)&&x(e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.B&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(ii,L);ii.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.A)}catch(e){Q(e,"WARNING")}}};
ii.prototype.o=function(){window.removeEventListener("message",this.m);L.prototype.o.call(this)};function ji(){var a=this.g=new ii(!!P("WIDGET_ID_ENFORCE")),b=A(this.Pa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=ji.prototype;m.Pa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,ki(this,a)),this.j[a]=!0)):this.la(a,b,c)};
m.la=function(){};
function ki(a,b){return A(function(c){this.sendMessage(b,c)},a)}
...
m.dispose=function(){this.g=null};function mi(a){ji.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Na,this));this.addEventListener("onVideoProgress",A(this.Wa,this));this.addEventListener("onVolumeChange",A(this.Xa,this));this.addEventListener("onApiChange",A(this.Ra,this));this.addEventListener("onPlaybackQualityChange",A(this.Ta,this));this.addEventListener("onPlaybackRateChange",A(this.Ua,this));this.addEventListener("onStateChange",A(this.Va,this));this.addEventListener("onWebglSettingsChanged",A(this.Ya,
this))}
t(mi,ji);m=mi.prototype;m.la=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Xh(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Zh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Yh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=$h.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Xh(a)&&li(this,this.fa())}};
m.Na=function(){var a=A(this.wa,this);this.g.f=a};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());li(this,a)};
m.Ta=function(a){li(this,{playbackQuality:a})};
m.Ua=function(a){li(this,{playbackRate:a})};
...
m.Xa=function(){li(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Wa=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:B()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());li(this,a)};
m.Ya=function(){var a={sphericalProperties:this.f.getSphericalProperties()};li(this,a)};
m.dispose=function(){ji.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function ni(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new bi(this,a,b);Tc(this,Ia(Uc,this.h))}
t(ni,L);ni.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,x(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ni.prototype.o=function(){Qf(this.j);this.f=null;L.prototype.o.call(this)};function oi(){var a=ab(pi),b;return ud(new M(function(c,d){a.onSuccess=function(e){re(e)?c(e):d(new qi("Request failed, status="+e.status,"net.badstatus",e))};
...
;function Bi(a){if("1"!==Va(ae(),"args","privembed")){a&&be();try{Ai().then(function(){},function(){}),S(Bi,18E5)}catch(b){Q(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ci(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
ya(Ci);var Gi=null,Hi=null,Ii=null,Ji={};function Ki(a){var b=a.id;a=a.ve_type;var c=sg++;a=new qg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Ji[b]=a;b=Lg();c=Kg();b&&c&&tg(b,c,[a])}
...
function Ni(a){var b=Lg(),c=Ji[a.id];if(b&&c){a=ug;c={csn:b,ve:rg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={ca:void 0,O:b};"UNDEFINED_CSN"==b?vg("visualElementGestured",c,d):pg("visualElementGestured",c,a,d)}}
function Oi(a){a=a.ids;var b=Lg();if(b)for(var c=0;c<a.length;c++){var d=Ji[a[c]];if(d){var e=ug;d={csn:b,ve:rg(d),eventType:1};var f={ca:void 0,O:b};"UNDEFINED_CSN"==b?vg("visualElementShown",d,f):pg("visualElementShown",d,e,f)}}}
...
y("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Bi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";b=x(b)?ac(b):b;var d=kh+"_"+(b[Ea]||(b[Ea]=++Fa)),e=jh[d];e&&(void 0===f||f)?e.loadNewVideoConfig(a):(e=new Vg(b,d,a,void 0),jh[d]=e,cf("player-added",e.api),Tc(e,Ia(lh,e)));a=e.api;Gi=a;a.addEventListener("onScreenChanged",
Li);a.addEventListener("onLogClientVeCreated",Ki);a.addEventListener("onLogServerVeCreated",Mi);a.addEventListener("onLogVeClicked",Ni);a.addEventListener("onLogVesShown",Oi);var f=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Ii=new mi(a):P("ENABLE_POST_API")&&x(f)&&x(c)&&(Hi=new ni(window.parent,f,c),Ii=new hi(a,Hi.h));c=$d("BG_P");Gf(c)&&(P("BG_I")||P("BG_IU"))&&(Cf=!0,Bf.initialize(P("BG_I",null),P("BG_IU",null),c,Ff,void 0));wf()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){Je(a+"mac_204?action_fcts=1");return!0},void 0);
var Pi=ee(function(){var a=Th(),b;(b=!R("use_first_tick"))||(b=!("ol"in Th()));if(b){b="ol";X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b));b=Rf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=vh();if(b=a.ol)tf(b),a.ol=0;a=Eh();a.gelTicks&&(a.gelTicks.tick_ol=!0);Rf();Dh()?(a=Ch(),ph("tick_ol_"+a)||mh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Th(),z("ytglobal.timingready_")&&
b&&a._start&&(b=Sh()))){Qh||(uh(zh,new xh(Math.round(b-a._start),void 0)),Qh=!0);b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Vh()}}a=Ci.getInstance();c=!!((Fi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":
"inverted-hdpi")):!b&&Xc(document.body,"inverted-hdpi")&&Yc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Fi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Qi=ee(function(){var a=Gi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//static.doubleclick.net/instream/ad_status.js");vf=!1;O("DCLKSTAT",0);Vc(Ii,Hi);if(a=Gi)a.removeEventListener("onScreenChanged",Li),a.removeEventListener("onLogClientVeCreated",Ki),a.removeEventListener("onLogServerVeCreated",Mi),a.removeEventListener("onLogVeClicked",Ni),a.removeEventListener("onLogVesShown",Oi),a.destroy();Ji={}});
window.addEventListener?(window.addEventListener("load",Pi),window.addEventListener("unload",Qi)):window.attachEvent&&(window.attachEvent("onload",Pi),window.attachEvent("onunload",Qi));Ja("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Hf);Ja("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||If);Ja("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||xf);
